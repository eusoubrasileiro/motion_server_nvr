cd motion-4.3/ && autoreconf -fiv && ./configure --without-v4l2 --without-mysql --without-mariadb -without-pgsql --without-sqlite3 CFLAGS='-g -O3 -ftree-vectorize -mcpu=cortex-a53 -march=armv8-a+crypto+crc+simd' 
